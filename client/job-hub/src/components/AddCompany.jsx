  ...
  return (
    <>
        ...
        <Modal show={show} onHide={handleClose} backdrop="static" keyboard={false}>
            ...
            <Modal.Body>
                <FloatingLabel controlId="floatingCompany" label="Company Name" className="mb-3">
                    <Form.Control type="text" placeholder="" onChange={(e)=>{Setcompany({...companyData,company:e.target.value})}} />
                </FloatingLabel>
                <FloatingLabel controlId="floatingLocation" label="Location / Address" className="mb-3">
